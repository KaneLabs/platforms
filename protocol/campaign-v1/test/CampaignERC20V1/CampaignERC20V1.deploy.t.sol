...
contract CampaignERC20V1DeployTest is TestBase {
    ...
    function test_Deploy_CorrectInitialState() public {
        ...
        assertEq(campaign.contributionToken(), address(0));
    ...
    function test_submitContribution_revert_NotInitialized() public {
        vm.expectRevert(CampaignERC20V1.NotInitialized.selector);
        campaign.submitContribution(0);
    }
