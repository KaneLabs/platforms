...
export default function LandingPageNav() {
  ...
  return (
    <div>
      <nav className="fixed left-0 right-0 top-10 mx-auto h-14 overflow-clip border-b border-gray-500/10">
      ...
      <div className="fixed h-10 py-2 px-2 w-full bg-gray-900 border-b border-gray-500/10 font-medium items-center text-brand-primary/75">
        <Link
