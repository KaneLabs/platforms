...
export default function DeletePostForm({ postName }: { postName: string }) {
  ...
  return (
    <form
      ...
      className="rounded-lg border border-accent-red bg-white dark:bg-gray-900"
    >
    ...
    <button
      className={cn(
        ...
        pending
          ...
          : "border-accent-red bg-accent-red text-white hover:bg-white hover:text-accent-red dark:hover:bg-transparent",
      )}
      disabled={pending}
    >
