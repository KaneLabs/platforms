...
export default function CreateOrganizationModal() {
  ...
  return (
    <form
      ...
      className="w-full rounded-md bg-gray-50 backdrop-blur-xl  dark:bg-gray-900/50 md:max-w-md md:border md:border-gray-400 md:shadow dark:md:border-gray-700"
    >
      <div className="relative flex flex-col space-y-4 p-5 md:p-10">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <input
            ...
            maxLength={32}
            required
            className="w-full rounded-md border border-gray-700 bg-gray-50 px-4 py-2 text-sm text-gray-900 placeholder:text-gray-700 focus:border-gray-900 focus:outline-none focus:ring-0 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-700 dark:focus:ring-gray-100"
          />
        </div>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex w-full max-w-md">
            <input
              ...
              maxLength={32}
              required
              className="w-full rounded-l-lg border border-gray-700 bg-gray-50 px-4 py-2 text-sm text-gray-900 placeholder:text-gray-700 focus:border-gray-900 focus:outline-none focus:ring-0 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-700 dark:focus:ring-gray-100"
            />
