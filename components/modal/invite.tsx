  ...
  return (
    <Form {...form}>
      <form
        ...
        className="w-full rounded-md bg-gray-50/50 backdrop-blur-xl  dark:bg-gray-900/50 md:max-w-md md:border md:border-gray-200 md:shadow dark:md:border-gray-800"
      >
